...
CLIENTES cl = new CLIENTES();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "Endereço", "Telefone", "Data Nascimento", "Data Cadastro"
            }
        ));
...
Pesquisa();
    ...
    try {
        ps = Conexão.getConexão().prepareStatement("SELECT * FROM CLIENTES");
    ...
    try {
        ps = Conexão.getConexão().prepareStatement("SELECT * FROM CLIENTES WHERE NOMEC LIKE ?");
